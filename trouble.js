let v1 = 3;
let v2 = 4; // aded ; to all the lines
alert("3 times 4" + "equals" + v1 * v2); // uncommented added quatatioon marks

 // This sets the general styling for the divs within the section tag using .style
            let section = document.getElementById("s1"); // element not elements
            section.style.width = "50%";
            section.style.textAlign = "center";
            section.style.fontFamily = "arial, serif";
            section.style.fontWeight = "bold"; // spell check
            ...
            // RED
            const red = document.getElementById("red"); // Cap E
            red.innerHTML = "RED";
